...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe9c3bfcb326a0cbf814f61b72799761) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "The Elm Architecture riding on camelback";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build example application";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build shorthand functor using Lwt";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build TyXML-based virtual DOM library";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_findlib_extra_files = ["react.js"; "react-dom.js"];
                   ...
                   {
                      lib_modules =
                        ["Caelm"; "Caelm_reactjs"; "Caelm_reactjs_wrapper"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Caelm_intf";
                           "Caelm_reactjs_intf";
                           "Caelm_reactjs_wrapper_intf"
                        ];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Caelm_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "caelm";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Caelm_reactjs_tyxml"; "Caelm_reactjs_tyxml_base"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Caelm_reactjs_tyxml_base_intf";
                           "Caelm_reactjs_tyxml_intf"
                        ];
                      lib_findlib_parent = Some "caelm";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "caelm_lwt";
                           InternalLibrary "caelm_tyxml";
                           FindlibPackage ("js_of_ocaml", None);
                           FindlibPackage ("js_of_ocaml.ppx", None);
     ...
     oasis_digest = Some "4\161\203\216\164\164K#\218\233l\173\231\180\012~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
