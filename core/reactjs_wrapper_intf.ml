...
class type image_element = object
  inherit element
...
class type input_element = object
  inherit element
...
class type data_transfer_item_list = object
  method add_string :
...
class type modifier_key_properties = object
...
class type point_properties = object
...
class type ['t] mouse_event = object
  inherit ['t] event
  inherit modifier_key_properties
  inherit point_properties
...
class type ['t] touch_event = object
  inherit ['t] event
  inherit modifier_key_properties
...
class type ['t] transition_event = object
  inherit ['t] event
  method elapsedTime : float readonly_prop
...
class type ['t] wheel_event = object
